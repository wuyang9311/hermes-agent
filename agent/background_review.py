...
_SKILL_REVIEW_PROMPT = (
    ...
    "skill_view in this turn — see the read-before-write rule below). "
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "of them covers the learning, PATCH it first (after re-loading it "
    "with skill_view in this turn — see the read-before-write rule "
    "below). It was in play; it's the right place.\n"
